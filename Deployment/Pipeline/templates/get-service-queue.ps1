...
$editedFiles | ForEach-Object {
	Switch -Wildcard ($_ ) {
		"pipelines/APIM/src/Input/products*" {
			Write-Host "APIM products changed"
			AppendQueueVariable "AllApis"
		}
		"pipelines/APIM/src/Output/*" {
			Write-Host "APIM output folder changed"
			AppendQueueVariable "AllApis"
		}
		"pipelines/APIM/src/Input/globalServicePolicy.xml*" {
			Write-Host "APIM global service policy changed"
			AppendQueueVariable "AllApis"
		}
		...
		"pipelines/APIM/src/Input/apis/DataUploadApi/*" {
			Write-Host "DataUploadApi changed"
			AppendQueueVariable "DataUploadApi"
		}
