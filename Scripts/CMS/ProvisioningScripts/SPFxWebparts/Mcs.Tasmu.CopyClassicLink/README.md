...
Solution|Author(s)
--------|---------
mcs-tasmu-copy-classic-link | Anoop T ([@anooptells](https://twitter.com/anooptells))
...
- In the command line navigate to the mcs-tasmu-copy-classic-link folder and run:
  - `npm install`
